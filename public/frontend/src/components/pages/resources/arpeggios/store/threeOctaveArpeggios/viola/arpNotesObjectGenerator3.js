///ARGPEEGIO SYSTEM
function arpNotesObjectGenerator3(
  key,
  durationValue,
  sequence,
  fingeringScheme,
  ...
  let rootPosition_3 = handleRootPosition_4(arpeggioIndex);
  ...
  arpMajorRootPosNotesTemplate = arpMajorRootPosNotesTemplate.concat(
    ...
    ArpeggioNotesArrayMajor.reverse().slice(1, 11)
  );
...
export default arpNotesObjectGenerator3;
