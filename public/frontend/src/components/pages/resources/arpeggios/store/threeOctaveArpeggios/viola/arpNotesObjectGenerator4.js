///ARGPEEGIO SYSTEM
function arpNotesObjectGenerator4(
  key,
  durationValue,
  sequence,
  fingeringScheme,
    ...
    if (i == 4 || i == 8 || i == 12) {
      ...
      if (i === 1 || i === 5 || i === 9) {
        ...
        if (
          ...
          ArpKeyValue =
            rootPosition_4 + "/" + (currentArpeggioOctave + 1).toString();
        } else {
          ArpKeyValue = rootPosition_4 + "/" + currentArpeggioOctave.toString();
        }
      } else {
        if (
          rootPosition_6 == "c" ||
...
export default arpNotesObjectGenerator4;
