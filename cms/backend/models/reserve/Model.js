...
groupSchema.index({ price: 1, ratingsAverage: -1 });
groupSchema.index({ slug: 1 });
groupSchema.index({ startLocation: "2dsphere" });

groupSchema.virtual("durationWeeks").get(function () {
...
const GroupClass = mongoose.model("GroupClass", groupSchema);
